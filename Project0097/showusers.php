...
<body class="fullpage">
    ...
    <div class="col-2" style=" background-color:blanchedalmond;border-radius:20px;margin-top:20px;margin-left:15px;">
        ...
        $sql = "SELECT Name, Email, Phone, Password FROM userlogin";
        $result = $conn->query($sql);

        if ($result->num_rows > 0) {
            echo "<table><tr><th>Name</th><th>Email</th><th>Phone</th><th>Password</th></tr>";
